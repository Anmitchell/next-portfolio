    ...
    return (
        <section className="z-40">
            ...
            >
                ...
                border border-black/10 focus:scale-110 hover:scale-110 transition cursor-pointer active:scale-105 hover:text-gray-950"><BsLinkedin /></a>

                <a 
                href='https://github.com/Anmitchell'
                target='_blank'
                className="bg-white p-4 text-gray-700 flex items-center justify-center gap-2 rounded-full border border-black/10 focus:scale-110 hover:scale-110 transition cursor-pointer active:scale-105 hover:text-gray-950"><BsGithub /></a>
            </motion.div>
        </section>
    )
}